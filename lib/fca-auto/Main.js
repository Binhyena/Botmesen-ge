        ...
        if (appState) {
            ...
            try {
                ...
                appState.map(function(c) {
                    ...
                    var cookieExpires = c.expires || (c.expirationDate ? new Date(c.expirationDate * 1000).toUTCString() : "");
                    var cookieDomain = c.domain || ".facebook.com";
                    var str = cookieKey + "=" + c.value + "; expires=" + cookieExpires + "; domain=" + cookieDomain + "; path=" + (c.path || "/") + ";";
                    var url = "http://" + (cookieDomain.startsWith(".") ? cookieDomain.slice(1) : cookieDomain);
                    try { jar.setCookie(str, url); } catch(e) {}
                });
